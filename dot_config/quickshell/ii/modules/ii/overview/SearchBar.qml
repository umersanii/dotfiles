...
RowLayout {
    ...
    enum SearchPrefixType { Action, App, Clipboard, PinnedClipboard, Emojis, Math, ShellCommand, WebSearch, DefaultSearch }
    ...
    property var searchPrefixType: {
        ...
        if (root.searchingText.startsWith(Config.options.search.prefix.pinnedClipboard)) return SearchBar.SearchPrefixType.PinnedClipboard;
    ...
    MaterialShapeWrappedMaterialSymbol {
        ...
        shape: switch(root.searchPrefixType) {
            ...
            case SearchBar.SearchPrefixType.PinnedClipboard: return MaterialShape.Shape.Gem;
        ...
        text: switch (root.searchPrefixType) {
            ...
            case SearchBar.SearchPrefixType.PinnedClipboard: return "keep";
